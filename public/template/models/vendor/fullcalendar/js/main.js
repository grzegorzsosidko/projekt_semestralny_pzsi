...
// models/vendor/fullcalendar/js/main.js
...
var FullCalendar = (function (exports) {
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence plugins don't guarantee that Cały dzień events are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    ----------------------------------------------------------------------------------------------------------------------*/
    // given a timed range, computes an Cały dzień range that has the same exact duration,
    ...
    // given a timed range, computes an Cały dzień range based on how for the end date bleeds into the next day
    ...
    /*
    Specifying nextDayThreshold signals that Cały dzień ranges should be sliced.
    */
    ...
    */
    ...
    eventConfig, mutation, context) {
        ...
        // in case event was Cały dzień but the supplied deltas were not
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        EventApi.prototype.setDates = function (startInput, endInput, options) {
            ...
            if (this._instance) {
                var instanceRange = this._instance.range;
                // when computing the diff for an event being converted to Cały dzień,
                // compute diff off of the Cały dzień values the way event-mutation does.
    ...
    */
    ...
    // HELPERS
    /*
    if nextDayThreshold is specified, slicing is done in an Cały dzień fashion.
    ...
    */
    ...
    function computeEventForDateSpan(dateSpan, dragMeta, context) {
        ...
        // only rely on time info if drop zone is Cały dzień,
    ...
    */
    ...
    var ListViewEventRow = /** @class */ (function (_super) {
        ...
        ListViewEventRow.prototype.render = function () {
            ...
            return (createElement(EventRoot, { seg: seg, timeText: "" // BAD. because of Cały dzień content
