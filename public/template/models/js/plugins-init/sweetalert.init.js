(function ($) {
    ...
    (document.querySelector(".sweet-wrong").onclick = function () {
        ...
        Swal.fire("Twoja sesja wkrótce wygaśnie, kliknij w dowolne miejsce, żeby ją przedłużyć!");
        }),
        ...
        (document.querySelector(".sweet-image-message").onclick = function () {
            Swal.fire({ title: "Sweet !!", text: "Hey, Here's a custom image !!", imageUrl: "images/hand.png", imageWidth: "20%" });
        }),
        (document.querySelector(".sweet-html").onclick = function () {
            Swal.fire({ title: "Sweet !!", text: "<span style='color:#ff0000'>Hey, you are using HTML !!<span>", html: !0 });
        }),
        (document.querySelector(".sweet-auto").onclick = function () {
            Swal.fire({ title: "Sweet auto close alert !!", text: "Hey, i will close in 2 seconds !!", timer: 2e3, showConfirmButton: !1 });
        }),
        (document.querySelector(".sweet-prompt").onclick = function () {
            Swal.fire({ title: "Enter an input !!", text: "Write something interesting !!", type: "input", showCancelButton: !0, closeOnConfirm: !1, animation: "slide-from-top", inputPlaceholder: "Write something" }, function (e) {
        ...
        (document.querySelector(".sweet-ajax").onclick = function () {
            Swal.fire({ title: "Sweet ajax request !!", text: "Submit to run ajax request !!", type: "info", showCancelButton: !0, closeOnConfirm: !1, showLoaderOnConfirm: !0 }, function () {
                setTimeout(function () {
