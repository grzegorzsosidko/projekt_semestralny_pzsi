        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Sekcja widoczna tylko dla administratora --}}
                    @if (auth()->user()->role == 'administrator')
                        <div class="hidden sm:flex sm:items-center sm:ms-6 border-l-2 pl-6">
                             <span class="font-medium text-sm text-gray-500">Panel Admina:</span>
                             <div class="hidden space-x-8 sm:-my-px sm:ms-4 sm:flex">
                                ...
                                <x-nav-link :href="route('admin.gallery.manage')" :active="request()->routeIs('admin.gallery.manage')">
                                    {{ __('Zarządzaj Galerią') }}
                                </x-nav-link>
                                 <x-nav-link :href="route('admin.knowledge.manage')" :active="request()->routeIs('admin.knowledge.manage')">
                                    {{ __('Zarządzaj Wiedzą') }}
                                </x-nav-link>
                                <x-nav-link :href="route('admin.documents.manage')" :active="request()->routeIs('admin.documents.manage')">
                                    {{ __('Zarządzaj Dokumentami') }}
                                </x-nav-link>
                            </div>
                        </div>
                    @endif
