...
class Event {
  ...
  // Returns whether the date range of our event intersects with the given Cały dzień range.
  // $rangeStart and $rangeEnd are assumed to be dates in UTC with 00:00:00 time.
  public function isWithinDayRange($rangeStart, $rangeEnd) {

    // Normalize our event's dates for comparison with the Cały dzień range.
